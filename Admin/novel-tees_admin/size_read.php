...
<div class="card">
              <div class="card-header">
                ...
                <a href="size_create.php" data-toggle="modal" data-target="#ProModal" class="btn btn-success float-right" >Add Size</a>
              </div>
...
if($check_result){
  while( $rows = mysqli_fetch_array( $data ) ) 
  {
      ?>
                    ...
                    <td><a href="size_update.php?id=<?php echo $rows ['id']?>"  class="btn btn-primary" >Update</a>
